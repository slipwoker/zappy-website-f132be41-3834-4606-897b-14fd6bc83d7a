    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בית הכנסת רמת גבעת זאב משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'f132be41-3834-4606-897b-14fd6bc83d7a',
                    name: data.name || '',
                    email: data.email || '',
